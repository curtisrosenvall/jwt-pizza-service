...
const { recordUserSignup, recordUserActivity  } = require('../metrics');
...
authRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    recordUserSignup({ email: user.email, id: user.id });
...
authRouter.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    // Record user activity with the auth token
    recordUserActivity(auth);
